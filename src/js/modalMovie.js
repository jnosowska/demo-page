...
export const modalMovie = async e => {
    ...
    const movie = await fetchJsonResponse(`https://api.themoviedb.org/3/movie/${id}`, {
        api_key: API_KEY,
        language: 'en-US',
    });
    ...
    const markup = `
            <div class="modal-movie__container">
                <img src="https://image.tmdb.org/t/p/w500${movie.poster_path}" alt="Image of movie" class="modal-movie__picture" />
                <div class="modal-movie__information">
                        ...
                        <tbody class="modal-movie__table modal-table">
                            <tr class="modal-table__row">
                                ...
                                <td class="modal-table__data modal-table__information">
                                    <span class="modal-table__number modal-table--orange">${Math.round(movie.vote_average*10)/10}</span> / 
                                    <span class="modal-table__number modal-table--grey">${movie.vote_count}</span>
                                </td>
                            </tr>
                            <tr class="modal-table__row">
                                <td class="modal-table__data modal-table__title">
                    ...
                    <div class="modal-movie__overview">
                        ...
                        <p class="modal-movie__description">${movie.overview}</p>
                    </div>
